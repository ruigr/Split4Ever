var ItemWgt = function(name){
	...
	this.config.requires = ['Utils', 'Constants', 'ItemWgt' ];
...
ItemWgt.prototype.start = function(){
	...
	this.context.dollarMap.$body.append(this.createView());
	this.doDollarMap();
...
ItemWgt.prototype.createView = function(){

	this.logger.in('createView');
